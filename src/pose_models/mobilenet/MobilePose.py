...
from src.pose_models.duc.DUC import DUC
from src.pose_models.mobilenet.mobilenet import MobileNetV2
from config.config import pose_classes, DUCs

n_classes = pose_classes
